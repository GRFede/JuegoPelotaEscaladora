...
// Eliminar plataformas que ya salieron por abajo
...
// Agregar nuevas plataformas en la parte superior si hace falta
...
for (let i = 0; i < 10; i++) {
  const x = Math.random() * (canvas.width - 100);
  const y = canvas.height - i * 100;
  platforms.push(new Platform(x, y, 100)); // touched será false por defecto
}
